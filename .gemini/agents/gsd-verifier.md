...
<required_reading>
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/verification-overrides.md
...
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/verify-mvp-mode.md`.
