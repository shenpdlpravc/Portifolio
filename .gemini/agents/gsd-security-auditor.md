...
**Verification depth scales with `asvs_level`** (see @/home/galletti/Projetos/my-project/.gemini/gsd-core/references/security-asvs-levels.md for full definitions):
