...
// hardcode the canonical path `@~/.gemini/gsd-core/...` (references, workflows,
...
// `~/.gemini/gsd-core/` is never created and every @-include resolves to
...
// `~/.gemini/gsd-core/` exists and its immutable subdirs (bin, contexts,
...
// are the directories `@~/.gemini/gsd-core/<subdir>/...` includes point into.
...
/**
 * Ensure the canonical `~/.gemini/gsd-core/` path exposes the bundled subdirs.
 *
