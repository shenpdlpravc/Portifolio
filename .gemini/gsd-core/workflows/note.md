...
- **Global scope**: `/home/galletti/Projetos/my-project/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/galletti/Projetos/my-project/.gemini/notes/`)
...
2. Glob `/home/galletti/Projetos/my-project/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/galletti/Projetos/my-project/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/galletti/Projetos/my-project/.gemini/notes/` — works in any directory
