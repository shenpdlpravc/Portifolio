...
INSTALL_JS_GLOBAL="/home/galletti/Projetos/my-project/.gemini/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/galletti/Projetos/my-project/.gemini/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
