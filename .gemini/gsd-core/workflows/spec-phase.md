...
ones). Reference: @/home/galletti/Projetos/my-project/.gemini/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/galletti/Projetos/my-project/.gemini.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/galletti/Projetos/my-project/.gemini/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/galletti/Projetos/my-project/.gemini/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/galletti/Projetos/my-project/.gemini/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/galletti/Projetos/my-project/.gemini/gsd-core/templates/spec.md.
