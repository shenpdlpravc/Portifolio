...
<required_reading>
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/ai-frameworks.md
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/galletti/Projetos/my-project/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/galletti/Projetos/my-project/.gemini/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/galletti/Projetos/my-project/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/galletti/Projetos/my-project/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/galletti/Projetos/my-project/.gemini/agents/gsd-eval-planner.md for instructions.
