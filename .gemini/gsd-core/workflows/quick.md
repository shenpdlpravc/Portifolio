...
- ./CLAUDE.md or ./.gemini/CLAUDE.md (if exists — project-specific guidelines)
...
- ./CLAUDE.md or ./.gemini/CLAUDE.md (if exists — follow project-specific guidelines)
...
- .planning/STATE.md (Project state)
- ./CLAUDE.md or ./.gemini/CLAUDE.md (Project instructions, if exists)
