...
```
Agent(
  prompt="Read /home/galletti/Projetos/my-project/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/galletti/Projetos/my-project/.gemini/gsd-core/templates/SECURITY.md`
