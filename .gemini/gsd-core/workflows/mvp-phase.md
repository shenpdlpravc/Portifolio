...
<required_reading>
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/user-story-template.md
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/spidr-splitting.md
@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/galletti/Projetos/my-project/.gemini/gsd-core/references/spidr-splitting.md`. Briefly:
