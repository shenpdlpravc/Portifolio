...
- Usage: Reference from command with `@/home/galletti/Projetos/my-project/.gemini/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/galletti/Projetos/my-project/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/galletti/Projetos/my-project/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
